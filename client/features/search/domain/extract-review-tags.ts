...
const RULES: Rule[] = [
  // ── 프린팅/원단 "튼튼" 구분 ──
  {
    re: /(프린팅|인쇄|프린트|그래픽|나염).{0,5}(안\s*벗겨|튼튼|안\s*갈라|오래|안\s*지워|안\s*떨어)|(안\s*벗겨|안\s*갈라).{0,5}(프린팅|인쇄|프린트|그래픽|나염)/,
    tag: "프린팅튼튼",
    bucket: "review",
  },
  {
    re: /탄탄|(원단|옷|재질|소재|티|기장).{0,3}튼튼|튼튼한\s*(원단|옷|티|재질|소재)|튼튼/,
    tag: "탄탄함",
    bucket: "review",
    unless: ["프린팅튼튼"],
  },
  ...
  { re: /넉넉/, tag: "넉넉핏", bucket: "review", unless: ["넥라인넉넉"] },
  ...
  // ── 소재 느낌 ──
  { re: /부드러|소프트|보들|부들/, tag: "부드러움", bucket: "review" },
  {
  ...
  {
    re: /두께\s*적당|적당한\s*두께|적당히\s*두꺼|너무\s*얇지/,
    tag: "두께적당",
    bucket: "review",
  },
  { re: /도톰|톡톡|두툼/, tag: "도톰함", bucket: "review", unless: ["두께적당"] },
  { re: /얇/, tag: "얇음", bucket: "review", unless: ["도톰함", "두께적당"] },
  {
  ...
  // ── 색/발색 ──
  {
    re: /화면.{0,5}(그대로|같|일치|동일|안\s*다르|다르지\s*않)|색.{0,4}화면.{0,4}(같|다르지\s*않)|실물.{0,3}(같|동일)|화면색\s*그대로|색\s*안\s*다르/,
    tag: "화면색상일치",
    bucket: "review",
  },
  {
  ...
  {
    re: /보풀\s*(안|없|덜|잘\s*안)|보푸라기\s*(안|없)/,
    tag: "보풀안생김",
    bucket: "review",
  },
  {
    re: /안\s*비치|비침\s*(없|적|없이)|안\s*비쳐|비쳐\s*보이지\s*않/,
    tag: "비침없음",
    bucket: "review",
  },
  ...
  {
    re: /귀여|큐트|깜찍|아기자기|그림\s*예쁜|캐릭터\s*(이쁜|귀)/,
    tag: "디자인귀여움",
    bucket: "review",
  },
  // ── 용도/TPO ──
  ...
  { re: /가벼운|가볍|경량|안\s*무거|무겁지\s*않/, tag: "가벼움", bucket: "review" },
  // ── 순수 결함 회피(제외 전용) ──
  { re: /안\s*무거|무겁지\s*않/, tag: "무거움", bucket: "exclude" },
  ...
  { re: /물\s*안\s*빠지|물빠짐\s*없|색\s*안\s*빠지/, tag: "물빠짐", bucket: "exclude" },
  {
