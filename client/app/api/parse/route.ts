...
예시:
입력: "회색 무지 티"
출력: {"baseColor":"회색","printColor":null,"printPosition":null,"fit":null,"graphicType":null,"gender":null,"functional":[]}
입력: "빨간 캐릭터 티셔츠"
출력: {"baseColor":"빨강","printColor":null,"printPosition":null,"fit":null,"graphicType":"캐릭터","gender":null,"functional":[]}
입력: "남성 검정 클라이밍 티"
출력: {"baseColor":"검정","printColor":null,"printPosition":null,"fit":null,"graphicType":null,"gender":"male","functional":[]}
입력: "등판에 검정 레터링 시원한 오버핏"
출력: {"baseColor":null,"printColor":"검정","printPosition":"뒤","fit":"오버","graphicType":"레터링","gender":null,"functional":["냉감"]}`;
